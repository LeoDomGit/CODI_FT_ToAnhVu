                ...
                if(todo.length > 0){
                    ...
                    todo.forEach((el,key) => {
                        if(el.status == 0){
                            str +=`
                            <tr>
                                <th scope="row"><p class=""todo>`+(++key)+`</p></th>
                                    <td>`+el.note+`</td>
                                    <td>
                                        <input type="checkbox" class="finish" data-id="`+el.id+`">
                                    </td>
                                    <td>
                                        <div class="d-grid gap-2 d-md-flex justify-content-center">
                                            <button class="btn btn-warning me-md-2 editBtn" type="button" data-id="`+el.id+`" data-key="`+key+`" data-value="`+el.note+`">Edit</button>
                                            <button class="btn btn-danger delBtn" type="button" data-id="`+el.id+`">Delete</button>
                                        </div>
                                    </td>
                            </tr>
                            `
                            ...
                            <tr>
                                <th scope="row"><p class=""todo>`+(++key)+`</p></th>
                                    <td>`+el.note+`</td>
                                    <td>
                                        <input type="checkbox" class="finish" disabled checked data-id="`+el.id+`">
                                    </td>
                                    <td>
                                        <div class="d-grid gap-2 d-md-flex justify-content-center">
                                            <button class="btn btn-warning me-md-2 editBtn" disabled type="button"  data-id="`+el.id+`" data-key="`+key+`" data-value="`+el.note+`">Edit</button>
                                            <button class="btn btn-danger delBtn" type="button" data-id="`+el.id+`">Delete</button>
                                        </div>
                                    </td>
                            </tr>
